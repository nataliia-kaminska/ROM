...
class User(Base):
    ...
    orcid_id: Mapped[str | None] = mapped_column(String(50), unique=True, nullable=True, index=True)
    password_login_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
